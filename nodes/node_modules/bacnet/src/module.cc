...
NAN_METHOD(InitInstance) {
    ...
    Nan::Set(target, New("deviceCommControl").ToLocalChecked(),
      Nan::GetFunction(New<FunctionTemplate>(deviceCommControl)).ToLocalChecked());
    Nan::Set(target, New("reInitDevice").ToLocalChecked(),
      Nan::GetFunction(New<FunctionTemplate>(reInitDevice)).ToLocalChecked());
    Nan::Set(target, New("subscribeCov").ToLocalChecked(),
      Nan::GetFunction(New<FunctionTemplate>(subscribeCov)).ToLocalChecked());
    Nan::Set(target, New("whoHasName").ToLocalChecked(),
      Nan::GetFunction(New<FunctionTemplate>(whoHasName)).ToLocalChecked());
    Nan::Set(target, New("whoHasObject").ToLocalChecked(),
      Nan::GetFunction(New<FunctionTemplate>(whoHasObject)).ToLocalChecked());
    // Nan::Set(target, New("readPropertyMultiple").ToLocalChecked(),
    //   Nan::GetFunction(New<FunctionTemplate>(readPropertyMultiple)).ToLocalChecked());
